...
`lehdr` is a very simple yet important R package to city planners and urban spatial analysts. Jamaal Green [cre, aut], Liming Wang [aut], Dillon Mahmoudi [aut], Matthew Rogers [ctb], and Kyle Walker [ctb] developed the package in 
...
**TO DO: add base layer of job distributions, and filter the flows to Philadelphia county (destination)."
...
```{r grab lodes PA NY wac, warning = FALSE, message = FALSE, include=TRUE}
...
wac_PA_NY_2015_2021 <- grab_lodes(
                                state= c('pa', 'oh'),
                                year=2015:2019,
                                lodes_type = "wac",
                                job_type = "JT01",
